...
namespace NoRecoil
{
    public partial class gui : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(txtCFG.Text))
            {
                MagicMouse.SaveIntConfig(_configLoc + @"\" + txtCFG.Text, settings);
            }
            else
            {
                MagicMouse.SaveIntConfig(_configLoc + @"\" + "Default", settings);
            }
        }
